...
// Get the changesets
const changesets1 = await db1.execA('select * from crsql_changes where db_version > ? AND site_id is null', [
	db1Version,
])
const changesets2 = await db2.execA('select * from crsql_changes where db_version > ? AND site_id is null', [
	db2Version,
])
